...
static CANIdFilterList_t StandardIDFilterPar_CH0[ CAN_STANDARD_ID_FILTER_NUMBER ] =
{
   /* FilterType,                      FilterElementConfiguration,       FilterID1,  FilterID2 */
    { CAN_FILTER_TYPE_DUAL,            CAN_FILTER_CFG_RXFIFO0,           0x009,      0x048 },
    { CAN_FILTER_TYPE_RANGE,           CAN_FILTER_CFG_REJECT_ID,         0x000,      0x7FF },
    { CAN_FILTER_TYPE_ELEMENTDISABLED, CAN_FILTER_CFG_DISABLE_ELEMENT,   0x000,      0x000 },
    { CAN_FILTER_TYPE_ELEMENTDISABLED, CAN_FILTER_CFG_DISABLE_ELEMENT,   0x000,      0x000 },
    { CAN_FILTER_TYPE_ELEMENTDISABLED, CAN_FILTER_CFG_DISABLE_ELEMENT,   0x000,      0x000 },
    { CAN_FILTER_TYPE_ELEMENTDISABLED, CAN_FILTER_CFG_DISABLE_ELEMENT,   0x000,      0x000 },
};
